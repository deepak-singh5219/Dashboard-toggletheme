...
const Interface = () => {
  ...
  return (
    <div style={{'background':theme.ui, 'border':'none', 'color':theme.syntax,}}>
      <div class="flex w-screen bg-[theme.bg] h-screen text-[theme.syntax]">


        <div style={{'background':theme.bg, 'color':theme.syntax}} class="flex flex-col items-center w-16 pb-4 overflow-auto border-r border-gray-300">
            <a class="flex items-center justify-center flex-shrink-0 w-full h-16 bg-gray-300" href="#">
                <svg class="w-8 h-8" style={{'background':theme.bg, 'color':theme.syntax}}  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div style={{'background':theme.bg, 'color':theme.syntax}} class="flex flex-col w-56 border-r border-gray-300">
        ...
        <div class="flex flex-col flex-grow">
            <div class="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
                ...
                <button onClick={toggleTheme} style={{'background':theme.bg, 'border':'none', 'color':theme.syntax, 'padding':'15px', 'margin':'15px'}} class="flex items-center justify-center h-10 px-4 ml-auto text-sm font-medium rounded hover:bg-gray-300">
                    Change Theme
                </button>
            ...
            <div style={{'background':theme.bg, 'color':theme.syntax}} class="flex-grow p-6 overflow-auto bg-gray-200">
                <div style={{'background':theme.bg, 'color':theme.syntax}} class="grid grid-cols-3 gap-6">
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-1 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-1 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-1 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-2 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-1 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-1 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-2 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-3 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-1 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-1 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-1 bg-white border border-gray-300"></div>
                    <div style={{'background':theme.bg, 'color':theme.syntax}} class="h-24 col-span-2 bg-white border border-gray-300"></div>
